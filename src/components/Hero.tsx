  ...
  return (
    <section className="grain relative flex min-h-screen flex-col justify-end overflow-hidden border-b border-border bg-background pb-24 pt-32 md:pb-32">
      ...
      <PageContainer className="relative z-10">
        <p className="font-clash mb-8 text-xs font-medium uppercase tracking-[0.25em] text-muted">
          Bangalore · Live-in workspace for builders
        </p>

        <h1 className="font-tektur tektur-flush m-0 block max-w-5xl text-balance text-6xl font-normal leading-[0.95] tracking-tight md:text-8xl lg:text-9xl">
          build.
          <br />
          live.
          <br />
